...
## Motivation
- The dataset used in this project provides patient reviews on specific drugs along with related conditions and a 10 star patient rating reflecting overall patient satisfaction. The data was obtained by crawling online pharmaceutical review sites  (Druglib.com). 
...
## Future Steps
- Try to extract words of side effects of each drugs from comments

      - Word similarity generated by Embedding layer    
      - Words positively correlated with rating/the label of side effect
...
- Strobl C, Boulesteix A L, Zeileis A, et al. Bias in random forest variable importance measures: Illustrations, sources and a solution[J]. BMC bioinformatics, 2007, 8(1): 25.
